...
public class test {
    ...
    public test(Context context){
        ...
        bddUser user = new bddUser(context , "User", null, 1);
        ...
        user.insert(1,"Nora","Vargas","cursus@nullaatsem.org","04/03/20",26);
        user.insert(2,"Geoffrey","Levy","Curae.Phasellus.ornare@congueturpis.edu","21/03/19",56);
        user.insert(3,"Kermit","Madden","Etiam.laoreet@per.edu","22/12/18",82);
        user.insert(4,"Richard","Zamora","diam.luctus.lobortis@sem.net","28/07/20",16);
        user.insert(5,"Cassidy","Booker","cursus.et@In.ca","22/10/19",72);
        user.insert(6,"Upton","Cochran","ultricies@ut.co.uk","16/02/19",21);
        user.insert(7,"Slade","Estrada","magna.tellus@ametdapibus.edu","26/02/20",87);
        user.insert(8,"Cailin","Harding","imperdiet.ullamcorper@sociisnatoquepenatibus.edu","24/06/20",85);
        user.insert(9,"Buckminster","England","adipiscing@blanditNam.ca","28/02/19",20);
        user.insert(10,"Fallon","Reyes","a.odio@senectus.org","31/12/18",19);
        user.insert(11,"Nevada","Lang","egestas@dolor.ca","30/06/20",40);
        ...
        //UPDATE
        user.update("pseudo","Pustule", "idu"+ " =?", "11" );

        //SELECT
        List itemIds = user.select( user.getProjection(), user.getKey() + " >?", new String[] {String.valueOf(5)});
        ...
        Log.d("STATE", "bye ### #########################################");
        //user.close();//pour sauvegarder les changements
    }
